        ...
        <section className="w-full py-12 md:py-24">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col gap-8">
              <div>
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">Properties</h1>
                <p className="mt-2 text-muted-foreground">Browse our selection of properties for sale and rent.</p>
              </div>
