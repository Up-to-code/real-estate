      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          <div className="flex flex-col items-center text-center border rounded-lg p-6 bg-background">
            ...
            <p className="mb-4">
              "EstateHub made finding our dream home a breeze. Their team was professional, knowledgeable, and always
          ...
          <div className="flex flex-col items-center text-center border rounded-lg p-6 bg-background">
            ...
            <p className="mb-4">
              "We sold our property in record time thanks to EstateHub. Their marketing strategy and network of buyers
          ...
          <div className="flex flex-col items-center text-center border rounded-lg p-6 bg-background">
            ...
            <p className="mb-4">
              "As a first-time investor, I appreciated the guidance and expertise that EstateHub provided. They helped
              me find the perfect investment property."
            </p>
